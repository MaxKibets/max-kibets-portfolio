...
export const VALIDATION_SCHEMA = z.object({
  [FIELDS[0]]: z.string().nonempty("Name is required"),
  [FIELDS[1]]: z.string().email("Invalid email").nonempty("Email is required"),
  [FIELDS[2]]: z.string().nonempty("Message is required"),
});
